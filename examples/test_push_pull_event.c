...
static void *server_thread_func(void *arg)
{
    ...
    int rc = uvzmq_socket_new(&loop, zmq_sock, server_on_recv, NULL, &data->received_count, &uvzmq_sock);
    if (rc != 0) {
...
{
    printf("========================================\n");
    printf("Event-Driven PUSH/PULL Test\n");
    printf("========================================\n\n");
